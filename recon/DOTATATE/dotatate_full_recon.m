function dotatate_full_recon(DOTATATE_patient_id)
    nx = 128;
    ny = 128;
    nz = 81;
    na = 120;
    ...
    foldername = strcat('./recon/fullrecon/', DOTATATE_patient_id, '/');
    filename_20iters = 'fullrecon_81_20iters.fld';
    filename = 'fullrecon_81.fld';
